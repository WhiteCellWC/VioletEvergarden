...
// Handlers
const submit = () => {
    form.post(route('paper-types.store'))
}
    ...
    <AdminLayout>
        <template #content>
            ...
            <form @submit.prevent="submit" class="p-8 flex flex-col w-1/2 gap-6">
                ...
                <div class="flex flex-col gap-2">
                    <Label for="price" mandatory>Price Per Page</Label>
                    <NumberInput id="price" placeholder="Input Price" v-model="form.price_per_page" />
                </div>
